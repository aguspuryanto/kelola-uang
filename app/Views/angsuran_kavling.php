...
<div class="container-fluid px-4">
    <h1 class="mt-4">Angsuran Kavling</h1>
        ...
        <div class="card-body">
            <form action="" method="get" class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <select name="lokasi" id="lokasi" class="form-select" onchange="this.form.submit()">
                        <?php foreach ($locations as $loc): ?>
                            <option value="<?= $loc['lokasi'] ?>" <?= ($selected_location == $loc['lokasi']) ? 'selected' : '' ?>>
                                <?= $loc['lokasi'] ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="col-md-8">
                    <div class="alert alert-info mb-0">
                        Total Angsuran untuk <?= esc($selected_location) ?>: 
                        <strong>Rp <?= number_format($total_angsuran, 0, ',', '.') ?></strong>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    Data Angsuran Kavling - <?= esc($selected_location) ?>
                </div>
                <div>
                        ...
                        <div class="modal fade" id="editModal<?= $row['id'] ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/angsuran-kavling/update/<?= $row['id'] ?>" method="post">
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <label for="lokasi" class="form-label">Lokasi</label>
                                                <select name="lokasi" class="form-select" required>
                                                    <?php foreach ($locations as $loc): ?>
                                                        <option value="<?= $loc['lokasi'] ?>" <?= ($row['lokasi'] == $loc['lokasi']) ? 'selected' : '' ?>>
                                                            <?= $loc['lokasi'] ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                        ...
                        <div class="modal fade" id="deleteModal<?= $row['id'] ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                        <a href="/angsuran-kavling/delete/<?= $row['id'] ?>" class="btn btn-danger">Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/angsuran-kavling/create" method="post">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="lokasi" class="form-label">Lokasi</label>
                        <select name="lokasi" class="form-select" required>
...
<div class="modal fade" id="importModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/angsuran-kavling/import" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="lokasi" class="form-label">Lokasi</label>
                        <select name="lokasi" class="form-select" required>
